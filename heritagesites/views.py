...
class SiteDetailView(generic.DetailView):
	...
	template_name = 'heritagesites/site_detail.html' #FROM SLIDES (24)# TODO add the correct template string value
...
#
# 	def get_queryset(self):
# 		return CountryArea.objects.all().select_related('location').order_by('country_area_name')
...
class SiteDeleteView(generic.DeleteView):
	...
	success_url = reverse_lazy('sites') # Adjusted to match appropriate "sites"
	context_object_name = 'site'
